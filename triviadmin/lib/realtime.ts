...
export type JoystickEvent =
    ...
    | { type: 'STATE_CHANGE'; state: 'READY' | 'CONNECTION_SUCCESS' | 'PAYING' | 'PAYMENT_APPROVED' | 'PLAYING' | 'WAITING'; game?: 'MENU' | 'TRIVIA' | 'RULETA' | 'CHANGO' | 'SIMON' | 'PENALTIES' | 'TAPRACE'; paymentUrl?: string }
    | { type: 'GAME_OVER' }
    | { type: 'TIMEOUT' };
