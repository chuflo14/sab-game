        ...
        <div className="space-y-10 pb-20 max-w-5xl mx-auto">
            <div className="flex justify-between items-center bg-white p-10 rounded-[2.5rem] border border-slate-200">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <h3 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Dedo de Chango</h3>
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Configuración técnica de dificultad</p>
                    </div>
                </div>
