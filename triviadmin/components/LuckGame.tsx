...
export default function LuckGame() {
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-8 p-8 min-h-[500px]">
            {/* Timer Display */}
            <div className={`
                text-7xl font-black mb-4 transition-colors duration-300
            ...
            {/* Game UI */}
            <div className="relative w-full max-w-2xl h-[450px] flex flex-col items-center justify-end pb-12">
                <GameResultOverlay
            ...
            <div className="mt-40 flex flex-col items-center gap-6">
                <div className="flex gap-4">
                    {['S', 'A', 'B'].map(k => (
                        <div key={k} className={`
                            w-16 h-16 rounded-xl border-4 flex items-center justify-center text-2xl font-black transition-all
                ...
                <div className="flex flex-col items-center gap-2">
                    <p className={`text-sm uppercase tracking-[0.3em] font-bold text-center transition-colors ${gameState === 'lost' ? 'text-red-500/50' : 'text-white/40 animate-pulse'}`}>
                        ¡Alterna las teclas S, A, B para inflar!
                    </p>
                </div>
